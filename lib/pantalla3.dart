...
class PerfilHijo3 extends StatelessWidget {
  const PerfilHijo3({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Perfil de Maria Ojeda'),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              _buildPendientesSection(context), // Separación entre el rectángulo del papá y los de los hijos // Separación entre el rectángulo del papá y los de los hijos
              Row(
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          CircleAvatar(
            radius: 50.0,
            backgroundImage: AssetImage('img/child3.jpg'),
          ),
          SizedBox(height: 16.0),
          Text(
            'Yui Vargas Grande',
          ...
          _buildInformacionSeccion(context, 'email', 'yui@edupay.com'),
